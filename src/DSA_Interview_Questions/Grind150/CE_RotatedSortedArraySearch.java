...
public class CE_RotatedSortedArraySearch {
    ...
    private static int searchOptimised(int[] arr, int target) {
        ...
        while (left <= right) {
            ...
            //If the left part is sorted, check if the target lies within this sorted part.
            //If yes, narrow the search to the left side. Otherwise, search on the right side.
            if (arr[left] <= arr[mid]) {
